...
@Component({
  ...
  template: `
    <aside class="w-64 flex flex-col h-full bg-linear-to-b from-primary-700 via-primary-800 to-primary-900 shadow-2xl relative">
      <!-- padded container so links stay aligned -->
      <!-- Decorative elements -->
      ...
      <nav class="flex flex-col flex-1 py-6 relative z-10 space-y-1 overflow-y-auto px-4">
        ...
        <a
          ...
          class="group flex items-center space-x-3 py-3.5 text-primary-50 hover:bg-white/15 rounded-xl transition-all duration-200">
